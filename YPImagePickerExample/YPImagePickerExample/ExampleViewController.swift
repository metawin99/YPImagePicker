...
class ExampleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        videoPickButton.setTitle("Video Pick", for: .normal)
        videoPickButton.setTitleColor(.black, for: .normal)
        videoPickButton.frame = CGRect(x: view.center.x - 50, y: view.center.y + 50, width: 100, height: 100)
        videoPickButton.addTarget(self, action: #selector(showVideoPicker), for: .touchUpInside)
        view.addSubview(videoPickButton)
